...
class BulletinTypeController extends Controller
{
    ...
    private function enrichValidatedData(Request $request, array $data): array
    {
        ...
        $data['output_mode'] = $data['output_mode'] ?? 'final_script';
    ...
    private function validated(Request $request, ?BulletinType $bulletinType = null): array
    {
        return $request->validate([
            ...
            'output_mode' => ['nullable', Rule::in(['final_script', 'plain_script', 'structured_script'])],
            'is_active' => ['boolean'],
    ...
    private function options(): array
    {
        return [
            ...
            'outputModes' => ['final_script', 'structured_script', 'plain_script'],
        ];
    }
}
