...
class EditorialScheduleRunService
{
    ...
    private function defaultPrompt(EditorialScheduleRun $run): string
    {
        ...
        return trim(implode("\n", [
            'You are producing a short digital news bulletin for presenter narration.',
            'Use recent, relevant, and verifiable current information. If your tool supports web browsing, use it.',
            'Do not invent facts. Prioritize verified events and provide source hints whenever possible.',
            'Avoid legal/medical/financial claims without clear attribution. If uncertain, separate confirmed facts from context.',
            'Keep paragraphs short and presenter-ready.',
            '',
            'Edition context (must be followed):',
            ...
            '',
            'Output instructions:',
            $schedule->output_instructions ?: 'Presenter-ready concise bulletin.',
            '',
            $languageInstruction,
            'Return plain text using this exact structure and headings:',
            '',
            'TITLE:',
            '[Short title for the bulletin]',
            '',
            'INTRO:',
            '[Presenter intro, 1-2 sentences]',
            '',
            'NEWS ITEMS:',
            '1. HEADLINE:',
            '[Headline]',
            ...
            '',
            'SCRIPT:',
            '[Presenter-ready narration for this item]',
            '',
            'EDITORIAL ANGLE:',
            '[Why this item matters for this edition]',
            '',
            'SOURCE HINTS:',
            ...
            '',
            'NOTES:',
            '[Uncertainty, missing verification, or editorial warnings]',
        ]));
    }
