    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <div className="relative min-w-[120px]">
                <select
                    id="language"
                    className="block w-full rounded-md border border-slate-300 bg-white py-1 pl-2 pr-9 text-xs text-slate-700 shadow-sm outline-none focus:border-slate-500 focus:ring-1 focus:ring-slate-500 md:text-sm [&::-ms-expand]:hidden"
                    style={{
                        appearance: 'none',
