...
export default function Index({ bulletinTypes }: any): JSX.Element {
 ...
 return <EditorLayout><Head title={t('Bulletin Types')} /><AdminPageHeader helpKey="editor.bulletintypes.index" title={t('Bulletin Types')} description={t('Noticiario type')} />
