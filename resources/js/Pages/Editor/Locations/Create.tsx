...
export default function Create({ parents, types, languages }: Props): JSX.Element {
    const { data, setData, post, processing, errors } = useForm({ parent_id: '', name: '', slug: '', type: 'country', country_code: '', timezone: '', default_language_id: '', is_active: true, sort_order: 0 });
