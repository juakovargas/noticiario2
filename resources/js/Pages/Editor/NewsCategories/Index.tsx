...
export default function Index({ newsCategories }: Props): JSX.Element {
    ...
    return <EditorLayout><Head title={t('News Categories')} /><AdminPageHeader title={t('News Categories')} description="Manage thematic categories." actionLabel={t('Create')} actionHref={route('editor.news-categories.create')} />
