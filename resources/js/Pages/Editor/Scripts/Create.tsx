...
export default function Create({ editions, statuses, selectedEditionId }: Props): JSX.Element {
    ...
    return (
        <EditorLayout>
            ...
            <AdminPageHeader title="Create Script" description="Create an editorial script manually." />
            <Card>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setData('edition_id', e.target.value)}
                            >
